...
[![Go Report Card](https://goreportcard.com/badge/github.com/LaunchPadLab/helm-mapkubeapis)](https://goreportcard.com/report/github.com/LaunchPadLab/helm-mapkubeapis)
[![CircleCI](https://circleci.com/gh/LaunchPadLab/helm-mapkubeapis/tree/master.svg?style=svg)](https://circleci.com/gh/LaunchPadLab/helm-mapkubeapis/tree/master)
[![Release](https://img.shields.io/github/release/LaunchPadLab/helm-mapkubeapis.svg?style=flat-square)](https://github.com/LaunchPadLab/helm-mapkubeapis/releases/latest)
...
```console
$ helm plugin install https://github.com/LaunchPadLab/helm-mapkubeapis
Downloading and installing helm-mapkubeapis v0.0.1 ...
https://github.com/LaunchPadLab/helm-mapkubeapis/releases/download/v0.0.1/helm-mapkubeapis_0.0.1_darwin_amd64.tar.gz
...
$ ./linux-amd64/helm plugin install https://github.com/LaunchPadLab/helm-mapkubeapis
```
...
The mapping information of deprecated or removed APIs to supported APIs is configured in the [Map.yaml](https://github.com/LaunchPadLab/helm-mapkubeapis/blob/master/config/Map.yaml) file. The file is a list of entries similar to the following:
...
$ cd $_
$ git clone git@github.com:LaunchPadLab/helm-mapkubeapis.git
$ cd helm-mapkubeapis
$ make
